<template>
  <h3 class="mrg-bot">18. interface WebSocketLike</h3>
    ...
    <el-table :data="WebSocketMethods" style="width: 100%">
      ...
      <el-table-column label="操作" width="80">
        <template #default="{row}">
          <el-button type="primary" size="small" @click="dataHelpeFun(row)">Edit</el-button>
        </template>
      </el-table-column>
    </el-table>
  </el-card>
  ...
  <el-divider />
  <h3 class="mrg-bot">19. class WebSocketProvider</h3>
  <el-card class="mrg-top">
    <h4 class="mrg-bot">PROPERTIES:</h4>
    ...
    <div class="code-comment mrg-bot">
      new WebSocketProvider(url: string | WebSocketLike | WebSocketCreator, network?: Networkish, options?:
      JsonRpcApiProviderOptions)
    </div>
    <el-button class="mrg-bot" type="primary" @click="newWebSocketProviderFun">new WebSocketProvider</el-button>
